    ...
    <div class="flex h-16 items-center justify-between">
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/about"
              class="<?= urlIs('/about') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">About
              us</a>
      ...
      <div class="hidden md:block">
        <div class="ml-4 flex items-center md:ml-6 gap-x-4">
          ...
          <div class="relative ml-3 flex items-center justify-center gap-x-4">
            <?php if ($_SESSION['user'] ?? false): ?>
              <button type="button"
              ...
              <form method="POST" action="/session">
                ...
                <button
                  class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm text-gray-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">Log
                  Out</button>
              </form>
            <?php else: ?>
              <a href="/register" class="text-gray-300">Register</a>
              <a href="/login" class="text-gray-300">Login</a>
            <?php endif ?>
          </div>
        </div>
      </div>
