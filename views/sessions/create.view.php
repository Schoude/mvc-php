...
<main>
  <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Log into your account</h2>
    </div>
      ...
      <form class="space-y-6" action="/session" method="POST">
        <div>
          ...
          <?php if (isset($errors['email'])) : ?>
            <div class="mt-2">
              <p class="text-red-400 font-bold text-xs"><?= $errors['email'] ?></p>
            </div>
          <?php endif ?>
        </div>
        ...
        <div>
          ...
          <?php if (isset($errors['password'])) : ?>
            <div class="mt-2">
              <p class="text-red-400 font-bold text-xs"><?= $errors['password'] ?></p>
            </div>
          <?php endif ?>
        </div>
